...
from wwc.workers.email.email_management_agent.utils.nodes import email_manager_node, email_human_node
...
email_management_graph = email_manager_builder.compile(name="email_management_graph")